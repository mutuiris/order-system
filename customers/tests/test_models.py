...
class CustomerModelTest(TestCase):
    ...
    def test_customer_creation(self):
        ...
        customer = Customer.objects.create(user=self.user, phone_number="+254700123456")
    ...
    def test_customer_str_with_no_full_name(self):
        ...
        customer = Customer.objects.create(
            user=user_no_name, phone_number="+254700123456"
        )
    ...
    def test_customer_unique_user_constraint(self):
        ...
        Customer.objects.create(user=self.user, phone_number="+254700123456")

        # Try to create second customer with same user
        with self.assertRaises(IntegrityError):
            Customer.objects.create(user=self.user, phone_number="+254700654321")
    ...
    def test_customer_inactive_state(self):
        ...
        customer = Customer.objects.create(
            user=self.user, phone_number="+254700123456", is_active=False
        )
    ...
    def test_customer_ordering(self):
        ...
        for i in range(3):
            ...
            customer = Customer.objects.create(
                user=user, phone_number=f"+25470012345{i}"
            )
