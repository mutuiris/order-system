...
class OrderItemInline(admin.TabularInline):
    ...
    fieldsets = (
        (None, {"fields": ("product", "quantity", "unit_price", "line_total")}),
    )
...
class OrderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Order Information", {"fields": ("order_number", "customer", "status")}),
        (
            "Financial Details",
            {
        ...
        ("Delivery Information", {"fields": ("delivery_address", "delivery_notes")}),
        (
            "Notifications",
            {"fields": ("sms_sent", "email_sent"), "classes": ("collapse",)},
        ),
        (
            "Timestamps",
